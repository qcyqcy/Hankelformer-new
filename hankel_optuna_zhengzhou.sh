...
# Zhengzhou配置（新增）
DATASET_CONFIGS["Zhengzhou,root_path"]="/share/home/qinchengyang/Time-Series-Library/dataset/ZZ-precipitation"
DATASET_CONFIGS["Zhengzhou,data_path"]="zhengzhou_hourly_weather_precipitation_2016_2021_complete.csv"
DATASET_CONFIGS["Zhengzhou,data"]="Zhengzhou"
DATASET_CONFIGS["Zhengzhou,enc_in"]="23"
DATASET_CONFIGS["Zhengzhou,target"]="OT"
...
if [ -z "$root_path" ]; then
    ...
    echo "Available datasets: ECL, Traffic, Zhengzhou"
    exit 1
fi
...
python optuna_runner_zhengzhou.py $config_file
