...
root_path="/share/home/qinchengyang/Time-Series-Library/dataset/oregon_washington"
# Datasets and prediction lengths
dataset=Northwest_Heatwave
...
for i in "${!pred_lens[@]}"; do
	python -u $run_path \
		--is_training 1\
		--model $model_name \
		--model_id oregon_washington_${pred_lens[$i]} \
		--root_path $root_path\
...
# # 变量赋值不能有空格
# run_path="/share/home/qinchengyang/Time-Series-Library/run.py"
# root_path="/share/home/qinchengyang/Time-Series-Library/dataset/TexasFreeze"
