...
# 方式1: 使用范围搜索（推荐，更智能）
# USE_RANGE_SEARCH=true

# # 范围搜索配置
# WINDOW_SIZE_MIN=1
# WINDOW_SIZE_MAX=24
# CONTRASTIVE_WEIGHT_MIN=0.01
...
python optuna_runner_traffic.py $config_file
...
echo "  - hankel_${DATASET}_pl*.dw (Optuna database)"
echo "========================================"
